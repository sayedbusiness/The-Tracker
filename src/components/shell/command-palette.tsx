...
const items: Item[] = [
  ...
  { group: "Navigate", icon: Briefcase, label: "Open Avori Growth", href: "/agency" },
  ...
  },
  {
    ...
    hint: "Opens Avori Growth and starts a new deal",
  },
  {
    group: "Quick action",
    icon: Upload,
  ...
  },
  {
    ...
    hint: "Opens Avori Growth and starts a new client",
  },
  {
    group: "Quick action",
    icon: Plus,
    ...
    hint: "Opens Avori Growth and starts a new campaign",
  },
  {
    group: "Quick action",
    icon: Brain,
